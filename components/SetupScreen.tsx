...
interface SetupScreenProps {
  ...
  onSettingsChange: (settings: { spyCount?: number, questionSource?: QuestionSource, familyFriendly?: boolean, noTimer?: boolean, roundLimit?: boolean, showQuestionToSpy?: boolean, anonymousVoting?: boolean, hideAnswerStatus?: boolean, playerId?: string, avatar?: string }) => void;
  onKickPlayer: (playerId: string) => void;
    onTransferHost: (playerId: string) => void;
    forcedSpies: Set<string>;
  }
  const SETTINGS_KEY = 'spy-game-online-settings';
  export const SetupScreen: React.FC<SetupScreenProps> = ({ onGameStart, players, isHost, roomId, localPlayerId, initialSettings, onSettingsChange, onKickPlayer, onTransferHost, forcedSpies }) => {
    ...
    const handleEmojiSelect = (emoji: string) => {
      if (playerIdToEditAvatar) {
        onSettingsChange({ playerId: playerIdToEditAvatar, avatar: emoji });
      }
